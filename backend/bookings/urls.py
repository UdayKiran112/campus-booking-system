...
urlpatterns = [
    ...
    path('alternative-slots/<int:venue_id>/', views.get_alternative_slots_view, name='alternative-slots'),
    ...
    path('<int:pk>/confirm-payment/', views.confirm_payment_view, name='confirm-payment'),
