...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserProfile
        fields = ['bio', 'profile_picture', 'no_show_count', 'total_bookings', 
                  'successful_bookings', 'reliability_score']
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'username', 'email', 'first_name', 'last_name', 'role', 
                  'department', 'phone_number', 'employee_id', 'student_id', 
                  'organization_name', 'verified', 'is_authority', 'profile', 
                  'created_at']
...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['username', 'email', 'password', 'password_confirm', 'first_name', 
                  'last_name', 'role', 'department', 'phone_number', 'employee_id', 
    ...
    def validate(self, data):
        ...
        if role == User.UserRole.EXTERNAL and not data.get('organization_name'):
            raise serializers.ValidationError("Organization name is required for external users")
